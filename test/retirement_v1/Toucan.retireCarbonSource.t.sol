...
contract ToucanRetireExactSourceTest is AssertionHelper {
    ...
    function testRetireBctDefaultWithUsdc() public {
        ...
        master.retireCarbon(USDC, BCT, 1e5, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithBct() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(BCT, BCT, 1e17, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithKlima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(KLIMA, BCT, 1e8, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithSklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(SKLIMA, BCT, 1e8, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithWsklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(WSKLIMA, BCT, 1e9, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
