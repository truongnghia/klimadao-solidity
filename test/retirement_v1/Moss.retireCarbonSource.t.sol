...
contract MossRetireExactSourceTest is AssertionHelper {
    ...
    function testRetireMossDefaultWithUsdc() public {
        ...
        master.retireCarbon(USDC, MCO2, 1e5, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireMossDefaultWithMco2() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(MCO2, MCO2, 1e17, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireMossDefaultWithKlima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(KLIMA, MCO2, 1e8, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireMossDefaultWithSklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(SKLIMA, MCO2, 1e8, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireMossDefaultWithWsklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(WSKLIMA, MCO2, 1e9, false, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
