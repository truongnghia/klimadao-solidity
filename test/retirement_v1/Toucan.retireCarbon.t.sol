...
contract ToucanRetireCarbonTest is AssertionHelper {
    ...
    function testRetireBctDefaultWithUsdc() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(USDC, BCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithBct() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(BCT, BCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");

        assertZeroTokenBalance(BCT, address(master));
        assertZeroTokenBalance(BCT, toucanHelper);
    }

    function testRetireBctDefaultWithKlima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(KLIMA, BCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithSklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(SKLIMA, BCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireBctDefaultWithWsklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(WSKLIMA, BCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireNctDefaultWithUsdc() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(USDC, NCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireNctDefaultWithNct() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(NCT, NCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireNctDefaultWithKlima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(KLIMA, NCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireNctDefaultWithSklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(SKLIMA, NCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
    ...
    function testRetireNctDefaultWithWsklima() public {
        vm.prank(0x375C1DC69F05Ff526498C8aCa48805EeC52861d5);
        master.retireCarbon(WSKLIMA, NCT, 1e17, true, 0x375C1DC69F05Ff526498C8aCa48805EeC52861d5, "test", "test");
